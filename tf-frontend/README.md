...
For a specific device: 
   - view devices: npx react-native run-ios --udid
   - run on device: npx react-native run-ios --udid <YOUR_DEVICE_UUID>
...
To build the Android application, you can use the following commands:
